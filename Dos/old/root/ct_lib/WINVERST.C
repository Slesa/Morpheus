/*ษออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออป
  บ  Funktionsname:    WinVerstecken                  Datum: 21.09.88      บ
  วฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤถ
  บ                                                                        บ
  บ  Parameter:        PWKB    pWkb   Zeiger auf den Kontrollblock des     บ
  บ                                   anzuzeigenden Windows.               บ
  บ                                                                        บ
  บ  Beschreibung:     Die Funktion nimmt das gewnschte Window vom Bild-  บ
  บ                    schirm und sichert es in dem Window-Buffer.         บ
...
WORD WinVerstecken (PWKB pWkb)
{
    ...
    if (wListe != awBit_m[wIndex])                  /* exis. Schnittflche? */
    {
        ...
        i_WinPop(wIndex);                           /* Window sichern       */
